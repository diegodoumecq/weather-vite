...
export const Compass = ({ speed, deg }: CompassProps) => {
  return (
    <div className="relative -mt-5 flex h-40 w-40 items-center justify-center md:-mt-5 md:h-36 md:w-36">
      ...
      <svg
        ...
        className="absolute invert transition-transform ease-in-out will-change-transform"
      >
